...
function SignalingChannel(serverURL, userId, sessionId) {
    ...
    var es = new EventSource(serverURL + "stoc/" + sessionId + "/" + userId);
    ...
    function PeerChannel(peerUserId) {
        ...
        function processSendQueue() {
            ...
            xhr.open("POST", serverURL + "ctos/" + sessionId + "/" + userId + "/" + peerUserId);
